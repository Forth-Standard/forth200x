...
sections \xref{usage}{Usage requirements} and
\xref{doc:system}{System documentation} and their sub-sections is
...
\xref{usage}{Usage requirements} and its sub-sections has
...
sections \xref{usage}{Usage requirements} and
\xref{doc:program}{Program documentation} and their sub-sections is
a Standard Program.
